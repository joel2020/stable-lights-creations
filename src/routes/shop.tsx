        ...
        <form onSubmit={onSubmit} className="space-y-8">
          ...
          <Card title="4. Confirm">
            ...
            <Button type="submit" disabled={submitting} size="lg" className="mt-6 w-full bg-[var(--neon-orange)] text-black hover:bg-[var(--neon-orange)]/90 font-bold text-base h-12">
              {submitting ? "Loading..." : `Continue to Checkout · $${price} + $29 shipping`}
            </Button>
        ...
        <aside className="lg:sticky lg:top-24 space-y-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-card p-6">
            ...
            <div className="mt-1 flex items-baseline gap-2">
              ...
              <span className="text-sm text-muted-foreground">+ $29 shipping</span>
            </div>
      ...
      <Dialog open={checkoutOpen} onOpenChange={setCheckoutOpen}>
        <DialogContent className="max-w-3xl max-h-[92vh] overflow-y-auto p-0 bg-white text-black">
          <DialogHeader className="px-6 pt-6">
            ...
            <DialogDescription>Secure payment via Stripe. A standard $29 shipping fee is applied at checkout. If actual shipping costs more, you'll receive an invoice for the difference. It's Lit Neon only charges exact shipping costs — not a penny more.</DialogDescription>
          </DialogHeader>
          <div className="p-4">
