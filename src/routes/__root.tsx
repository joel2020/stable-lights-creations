    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://itslitneon.com/#organization",
            ...
            {
              "@type": "WebSite",
              "@id": "https://itslitneon.com/#website",
              url: "https://itslitneon.com",
              name: "It's Lit Neon",
              publisher: { "@id": "https://itslitneon.com/#organization" },
            },
          ],
        }),
      },
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="dark">
      <head>
        <HeadContent />
        {/* Vercel Web Analytics — no-op until enabled on the Vercel project */}
