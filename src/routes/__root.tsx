...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium custom neon clocks personalized with your name, logo, photo, business, team, garage, or bar. Bold wall decor and one-of-a-kind gifts that glow." },
      { name: "keywords", content: "custom neon clocks, personalized neon clock, custom logo neon clock, neon wall clock, neon clocks for businesses, garage neon clock, bar neon clock, restaurant neon clock, man cave neon clock, gift neon clock" },
      ...
      { property: "og:description", content: "Premium custom neon clocks personalized with your name, logo, photo, business, team, garage, or bar. Wall decor that glows." },
