  ...
  head: () => ({
    meta: [
      { title: "It's Lit Neon · Custom Harness Racing Stable Clocks" },
      {
        name: "description",
        content:
          "Custom neon clocks for harness racing stables, owners, trainers, drivers & racetracks. Your stable name, silks colors, and racing logo — hand-built one at a time.",
      },
      {
        name: "keywords",
        content:
          "harness racing clock, stable neon clock, custom racing stable sign, harness racing gift, trainer driver gift, racetrack memorabilia",
      },
      { property: "og:title", content: "Custom Harness Racing Stable Neon Clocks · It's Lit Neon" },
      {
        property: "og:description",
        content:
          "Personalized neon clocks for harness racing stables, drivers, trainers, and tracks. Built one at a time.",
      },
          ...
          "@graph": [
            {
              ...
              description:
                "Pre-designed neon wall clock with chrome border, quartz movement, and your choice of 7 neon glow colors. Perfect for homes, garages, businesses, and man caves.",
            ...
            },
            {
              ...
              description:
                "Fully personalized neon wall clock featuring your name, business, logo, photo, or memorial design. Handmade one at a time.",
              brand: { "@type": "Brand", name: "Light Me Up Productions" },
              offers: {
                "@type": "Offer",
                price: "125.00",
  ...
  return (
    <PageShell>
        ...
        <div className="relative mx-auto max-w-7xl px-4 pt-10 pb-12 md:px-6 md:pt-20 md:pb-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-base md:text-lg text-muted-foreground">
              Custom neon clocks for harness racing stables, owners, trainers, drivers, and
              racetracks. Your stable name, your silks colors, your racing logo — hand-built one at
              a time. The perfect piece for the tack room, the office, or as a gift for the team.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
              ...
              <span className="flex items-center gap-1">
                <Check className="h-4 w-4 text-[var(--neon-green)]" /> On/off neon switch
              </span>
              <span className="flex items-center gap-1">
                <Check className="h-4 w-4 text-[var(--neon-green)]" /> Chrome-style border
              </span>
            </div>
          </div>
            ...
            {Array.from({ length: 2 }).map((_, k) => (
              <div key={k} className="flex shrink-0">
                {[
                  ...
                  <span key={t} className="flex items-center gap-4 px-6">
      ...
      <section className="relative z-20 mx-4 md:mx-6 mt-6 mb-6 max-w-7xl lg:mx-auto">
        <div className="coupon-banner rounded-2xl border-2 border-[var(--neon-orange)]/80 bg-[var(--neon-orange)]/15 px-6 py-4 text-center backdrop-blur">
          <div className="flex flex-col items-center justify-center gap-1 sm:flex-row sm:gap-3">
            <span className="text-sm font-bold uppercase tracking-widest text-[var(--neon-orange)]">
              Limited Time Offer
            </span>
      ...
      <section className="relative border-y border-[var(--neon-orange)]/30 bg-gradient-to-b from-black/60 to-black/30">
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-24">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            <div className="max-w-2xl">
              <div className="text-xs uppercase tracking-widest text-[var(--neon-orange)]">
                Harness Racing Stable Clocks
              </div>
              <h2 className="mt-3 font-display text-4xl md:text-5xl chrome-text">
                BUILT FOR THE STABLE
              </h2>
              <p className="mt-4 text-muted-foreground text-lg">
                Our most-loved builds. Stable name across the top, your horse-and-driver silhouette
                in the middle, "Racing Stable" arched below — finished in the neon color of your
                silks. A staple in tack rooms, trainer offices, and owners' dens across North
                America.
              </p>
            </div>
            <Button
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3 text-sm">
            {[
              {
                t: "Your Stable, Your Silks",
                d: "Pick any of 7 neon colors to match your racing colors — red, orange, yellow, green, blue, purple, or white.",
              },
              {
                t: "Driver & Horse Artwork",
                d: "Classic harness racing silhouette or upload your own logo, brand, or driving photo.",
              },
              {
                t: "Tack Room Ready",
                d: '20" chrome bezel, quartz movement, on/off neon switch. Built one at a time, ships in 2–3 weeks.',
              },
            ].map((b) => (
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-24">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-3 font-display text-4xl md:text-5xl">
            Pick Your Clock. Make It Yours.
          </h2>
          <p className="mt-4 text-muted-foreground text-lg">
            Every clock is hand-built one at a time. Start with a clean classic or go fully custom —
            your name, logo, photo, or design on the face.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <ProductCard
            ...
            features={[
              ...
              "Custom face artwork",
              "Your name, stable, business, or logo",
              "Memorial & gift designs",
        ...
        <p className="mt-4 text-center text-sm text-muted-foreground">
          Prices shown plus shipping. A standard $29 shipping fee is applied at checkout. If actual
          shipping is more, you'll get an invoice for the difference — we only charge exact shipping
          costs, not a penny more. Multiple clocks ship together for less. International/Canadian
          quoted separately.
        </p>
      </section>
      ...
      <section className="border-y border-white/10 bg-black/30">
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-4xl md:text-5xl">
              A Clock for Every Wall, Brand & Occasion
            </h2>
            <p className="mt-4 text-muted-foreground text-lg">
              From boardrooms to barrooms, garages to game rooms. If you've got a wall, we've got a
              clock for it.
            </p>
          </div>
            ...
            {[
              {
                i: Trophy,
                c: "orange",
                t: "Harness Racing Stables & Tracks",
                d: "Stable names, driver/trainer tributes, racetrack memorabilia, and silks-color builds for owners, trainers, drivers, and grooms.",
              },
              {
                i: Gift,
                c: "blue",
                t: "Personalized Gifts & Memorials",
                d: "Birthdays, anniversaries, retirements, weddings, and tribute pieces that last a lifetime.",
              },
              {
                i: Building2,
                c: "yellow",
                t: "Business & Logo Clocks",
                d: "Branded wall decor for offices, studios, salons, barbershops, gyms, and retail floors.",
              },
              {
                i: Wine,
                c: "red",
                t: "Bars, Restaurants & Cafés",
                d: "Statement pieces for bars, lounges, diners, breweries, and coffee shops.",
              },
              {
                i: Wrench,
                c: "green",
                t: "Garages, Auto Shops & Dealerships",
                d: "Custom logos, classic builds, and shop signage that glow above the lift.",
              },
              {
                i: Gamepad2,
                c: "purple",
                t: "Game Rooms, Man Caves & Home Bars",
                d: "Personalized clocks for basements, dens, pool rooms, and home theaters.",
              },
            ].map((u) => (
              <div
                key={u.t}
                className="rounded-2xl border border-white/10 bg-card p-5 hover:border-white/30 transition"
              >
                <div
                  className={`grid h-10 w-10 place-items-center rounded-full ring-glow-${u.c} bg-black`}
                >
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-12">
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {galleryClocks.slice(0, 5).map((c) => (
            <figure key={c.caption} className="group flex flex-col items-center">
              <div
                className={`relative aspect-square w-full overflow-hidden rounded-full border-2 border-white/10 bg-black ring-glow-${c.color} transition-transform duration-300 group-hover:-translate-y-1`}
              >
                <img
                  src={c.src}
                  alt={c.alt}
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16" id="video-showcase">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 text-center">
          <p className="text-muted-foreground max-w-md">
            Ready to turn your name, logo, or photo into a clock that glows? Start your build today.
          </p>
          <Button
            asChild
            size="lg"
      ...
      <section className="border-y border-white/10 bg-black/40">
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-4xl md:text-5xl chrome-text">
              CUSTOM NEON CLOCKS IN ACTION
            </h2>
            <p className="mt-4 text-muted-foreground text-lg">
              Real clocks we've built for bars, garages, game rooms, businesses, and gift moments.
              Each one is hand-crafted to order and built to be the focal point of the room.
            </p>
          </div>
          <div className="mt-10 grid md:grid-cols-2 gap-6">
            {[
              {
                src: stableClocks[9].src,
                label: "Burke Racing Stable · Installed",
                alt: "Burke Racing Stable neon clock installed on a stable wall",
              },
              {
                src: stableClocks[1].src,
                label: "Meadowlands Racetrack · Blue Neon",
                alt: "Meadowlands Racetrack custom blue neon clock",
              },
            ].map((s) => (
              <figure
                key={s.label}
          ...
          <div className="grid grid-cols-3 border-t border-white/10">
            ...
            <div className="p-4 md:p-5 border-l border-white/10">
              <Button asChild className="w-full bg-white/10 hover:bg-white/15 font-bold">
                <Link to="/shop" search={{ type: "regular" } as never}>
                  Order Regular
                </Link>
              </Button>
            </div>
            <div className="p-4 md:p-5 border-l border-white/10 bg-[var(--neon-orange)]/5">
              <Button
                asChild
                className="w-full bg-[var(--neon-orange)] text-black hover:bg-[var(--neon-orange)]/90 font-bold"
              >
                <Link to="/shop" search={{ type: "custom" } as never}>
                  Build Custom
                </Link>
              </Button>
            </div>
      ...
      <section className="border-y border-white/10 bg-black/30">
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-20">
          ...
          <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              {
                q: "Joe builds a beautiful clock. The detail and the glow are unreal — looks even better in person.",
                n: "D.M. Hollywood, FL",
                c: "orange",
              },
              {
                q: "Hands down the coolest piece of memorabilia I own. Quality is top-shelf.",
                n: "T.T. Las Vegas, NV",
                c: "yellow",
              },
              {
                q: "Custom from top to bottom. Joe nailed every detail we asked for.",
                n: "J.H. Miami, FL",
                c: "blue",
              },
              {
                q: "Best gift I've ever gotten. It's the first thing everyone notices when they walk in.",
                n: "M.R. Chicago, IL",
                c: "red",
              },
              {
                q: "Hung it in the office and every visitor stops dead. Worth every penny.",
                n: "S.B. Austin, TX",
                c: "red",
              },
              {
                q: "We've got Joe's clocks all over the property. They're a fan favorite.",
                n: "K.P. Denver, CO",
                c: "green",
              },
            ].map((t) => (
              ...
              >
                ...
                <figcaption className="mt-4 flex items-center gap-3 pt-4 border-t border-white/10">
                  <div
                    className={`h-9 w-9 rounded-full ring-glow-${t.c} bg-black grid place-items-center text-[10px] font-bold uppercase`}
                    style={{ color: `var(--neon-${t.c})` }}
                  >
                    ★
                  </div>
          ...
          {[
            {
              i: Zap,
              t: "Send Us Your Idea",
              d: "Tell us what you want — name, logo, photo, business, team, or memorial.",
            },
            {
              i: Upload,
              t: "We Create the Design",
              d: "Joe mocks up your custom clock face and sends it over for review.",
            },
            {
              i: Palette,
              t: "Approve Your Look",
              d: "Pick your neon glow color and lock in any final tweaks.",
            },
            {
              i: Truck,
              t: "We Build & Ship",
              d: "Your one-of-a-kind clock is hand-built and shipped right to your door.",
            },
          ].map((s, idx) => (
            <div key={s.t} className="relative rounded-2xl border border-white/10 bg-card p-6">
              <div className="absolute -top-3 left-6 rounded-full bg-[var(--neon-orange)] px-3 py-0.5 text-xs font-bold text-black">
                STEP {idx + 1}
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="font-display text-4xl md:text-5xl">
              Everything You Can{" "}
              <span className="text-[var(--neon-orange)] text-glow-orange">Customize</span>
            </h2>
            <p className="mt-4 text-muted-foreground">
              Make it yours, end-to-end. The custom build lets you control every detail of the face.
            </p>
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <li key={x} className="flex items-start gap-2 text-sm">
                  <Check className="h-4 w-4 mt-0.5 text-[var(--neon-orange)]" />
                  {x}
                </li>
              ))}
            </ul>
          ...
          <div className="grid grid-cols-7 gap-2">
            {[
              ...
              <div
                key={n.c}
                className={`aspect-[1/2] rounded-full ring-glow-${n.c} bg-black/60 grid place-items-center text-[10px] font-bold tracking-widest text-glow-${n.c}`}
              >
                {n.t}
              </div>
            ))}
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-6 py-16 md:py-24 text-center">
        ...
        <h2 className="mt-4 font-display text-4xl md:text-5xl chrome-text">
          THE FOCAL POINT OF EVERY ROOM
        </h2>
        <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
          Premium custom neon clocks that turn any wall into a statement — perfect for businesses,
          garages, bars, game rooms, offices, and giftable moments people remember.
        </p>
      </section>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 md:px-6 py-20 text-center">
          <h2 className="font-display text-4xl md:text-6xl">
            Ready to build a clock that{" "}
            <span className="text-[var(--neon-orange)] text-glow-orange">
              glows like nothing else?
            </span>
          </h2>
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Send us your idea — your name, logo, photo, or business — and we'll turn it into a
            one-of-a-kind neon clock.
          </p>
...
const FAQ_HOME = [
  {
    ...
    a: "Regular clocks ship within a few business days. Custom builds typically take 2-3 weeks once we finalize the design with you.",
  },
  {
    q: "Can I send my logo or a photo?",
    a: "Absolutely — logos, photos, artwork, business branding, team graphics, memorial photos. Higher resolution gives the cleanest result, and we'll let you know if anything needs to be re-sent before production.",
  },
  {
    q: "Can I use my own colors?",
    a: "Yes. Send us your brand colors, team colors, or favorite combos and we'll work them into the design.",
  },
];
  ...
  return (
    <>
      ...
      <div className="p-4 md:p-5 border-t border-l border-white/10 text-center">
        {reg ? (
          <Check className="inline h-5 w-5 text-[var(--neon-green)]" />
        ) : (
      ...
      <div className="p-4 md:p-5 border-t border-l border-white/10 text-center bg-[var(--neon-orange)]/5">
        {cus ? (
          <Check className="inline h-5 w-5 text-[var(--neon-orange)]" />
        ) : (
          <span className="text-muted-foreground" aria-label="Not included">
            —
          </span>
...
function ProductCard({
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl border bg-card p-6 pt-11 md:p-8 md:pt-12 transition ${highlight ? "border-[var(--neon-red)]/50 ring-glow-red" : "border-white/10 hover:border-white/30"}`}
    >
      <div
        className={`absolute top-4 left-6 z-20 max-w-[calc(100%-3rem)] whitespace-nowrap rounded-full px-3 py-1 text-xs font-bold leading-none ${color === "red" ? "bg-[var(--neon-red)] text-white" : "bg-[var(--neon-orange)] text-black"}`}
      >
        {badge}
      </div>
      <div className="grid sm:grid-cols-[200px,1fr] gap-5 md:gap-6 items-center">
        <div className="relative mx-auto w-44 sm:w-full">
          ...
          <div
            ...
            style={{
              background: `radial-gradient(circle, var(--neon-${imageGlow}) 0%, transparent 65%)`,
            }}
          />
          <div
            className={`relative aspect-square w-full overflow-hidden rounded-full border-2 border-white/10 bg-black transition-shadow duration-500 ${lit ? `ring-glow-${imageGlow}` : ""}`}
          >
            {imageUnlit && (
              <img
                src={imageUnlit}
                alt=""
                loading="eager"
                className={`absolute inset-0 h-full w-full object-cover object-center transition-opacity duration-500 ${lit ? "opacity-0" : "opacity-100"}`}
              />
            )}
            <img
              src={image}
              alt={`${title} example`}
              loading="eager"
              className={`absolute inset-0 h-full w-full object-cover object-center transition-all duration-500 ${lit ? "opacity-100 group-hover:scale-125" : "opacity-0"}`}
            />
          </div>
          {imageUnlit && (
            <div className="mt-3 flex justify-center">
              <div className="inline-flex rounded-full border border-white/10 bg-black/70 p-0.5 text-[10px] font-bold uppercase tracking-widest">
                <button
                  ...
                  className={`px-3 py-1 rounded-full transition ${!lit ? "bg-white/10 text-white" : "text-muted-foreground"}`}
                >
                  Off
                </button>
                <button
                  onClick={() => setLit(true)}
                  className={`px-3 py-1 rounded-full transition ${lit ? `bg-[var(--neon-${imageGlow})] text-black` : "text-muted-foreground"}`}
                >
                  Lit
                </button>
              </div>
      ...
      <ul className="mt-5 grid gap-2 text-sm sm:grid-cols-2">
        {features.map((f) => (
          <li key={f} className="flex items-start gap-2">
            <Check className="h-4 w-4 mt-0.5 text-[var(--neon-orange)] shrink-0" />
            {f}
          </li>
        ))}
      </ul>
      <Button
        asChild
        size="lg"
        className="mt-6 w-full bg-[var(--neon-orange)] text-black hover:bg-[var(--neon-orange)]/90 font-bold"
      >
        <Link to="/shop" search={{ type: price === 99 ? "regular" : "custom" } as never}>
          Order Now
        </Link>
      </Button>
    </div>
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[560px]">
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle, var(--neon-${active.color}) 0%, transparent 62%)`,
        }}
      />
      {/* outer chrome bezel — slow rotation */}
      <div
        className="absolute inset-0 rounded-full p-[7px] chrome-spin transition-[background] duration-700"
        style={{
          background: `conic-gradient(from 0deg, #1a1a1f, var(--neon-${active.color}), #6a6f78, var(--neon-${active.color}), #2a2a31, var(--neon-${active.color}), #1a1a1f)`,
        }}
      >
        <div className="relative h-full w-full rounded-full bg-black p-[3px]">
          {/* inner chrome ring (static) */}
          <div
            className="relative h-full w-full overflow-hidden rounded-full p-[10px]"
            style={{
              background:
                "linear-gradient(145deg, #2a2a31 0%, #cfd3da 35%, #6a6f78 55%, #e8eaf0 80%, #1a1a1f 100%)",
            }}
          >
            {/* neon ring with image */}
            <div
              className={`relative h-full w-full overflow-hidden rounded-full bg-black ring-glow-${active.color} transition-shadow duration-700 neon-pulse`}
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 30% 18%, rgba(255,255,255,0.22) 0%, transparent 38%)",
                }}
              />
            </div>
          </div>
      ...
      <div
        className="hidden md:block absolute -right-4 top-1/3 rounded-full border border-white/15 bg-black/70 backdrop-blur px-3 py-1.5 text-[11px] font-bold uppercase tracking-widest"
