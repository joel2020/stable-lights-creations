...
const FAQS = [
  ...
  { q: "How much does shipping cost?", a: "A standard $29 shipping fee is billed at checkout. If the actual shipping cost is more, you'll receive a separate invoice for the difference — It's Lit Neon only charges you the exact shipping cost and not a penny more. Ordering multiple clocks together is more cost-effective — we combine shipping. International and Canadian orders are quoted separately based on destination." },
  ...
  { q: "Can I order multiple clocks for my business or team?", a: "Yes. Email support@itslitneon.com for multi-clock and bulk pricing for businesses, teams, dealerships, and gift orders." },
  ...
  { q: "Where are you based?", a: "It's Lit Neon is run by Light Me Up Productions. Reach us by email at support@itslitneon.com." },
];
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-card p-6 text-center">
          ...
          <div className="mt-4 flex flex-col sm:flex-row justify-center gap-3">
            <Button asChild className="bg-[var(--neon-orange)] text-black hover:bg-[var(--neon-orange)]/90 font-bold">
              <a href="mailto:support@itslitneon.com">Email support@itslitneon.com</a>
            </Button>
