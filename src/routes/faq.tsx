...
const FAQS = [
  ...
  { q: "How much does shipping cost?", a: "U.S. shipping starts at $30 and is confirmed on your invoice. Ordering multiple clocks together is more cost-effective — we combine shipping. International and Canadian orders are quoted separately based on destination." },
