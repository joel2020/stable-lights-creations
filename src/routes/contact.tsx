  ...
  return (
    <PageShell>
      <section className="mx-auto max-w-4xl px-4 md:px-6 pt-10 pb-16">
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">Fastest way to order or ask a question is to text Joe directly. He'll walk you through the design.</p>
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-card p-6 md:p-8">
          ...
          <p className="mt-2 text-muted-foreground">Use our customizer to send Joe everything he needs in one shot.</p>
