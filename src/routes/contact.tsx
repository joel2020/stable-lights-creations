...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Talk to It's Lit Neon. Call or text 702-460-9190 or email support@itslitneon.com to design your custom neon clock for any home, business, or gift." },
  ...
  return (
    <PageShell>
      <section className="mx-auto max-w-4xl px-4 md:px-6 pt-10 pb-16">
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">Fastest way to get a custom quote, send us your logo, or ask a question is to call or text us directly. We'll walk you through the design and pricing.</p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <a href="sms:+17024609190" className="group rounded-2xl border border-white/10 bg-card p-6 hover:border-[var(--neon-orange)] hover:ring-glow-orange transition">
            ...
            <div className="mt-3 font-display text-2xl">Call or Text</div>
